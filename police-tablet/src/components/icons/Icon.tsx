...
const paths: Record<IconName, React.ReactNode> = {
  ...
  car: (
    <>
      <path d="M5 15l1.5-5a2 2 0 0 1 1.9-1.4h8.2a2 2 0 0 1 1.9 1.4L19 15" />
      <path d="M3 15h18v3a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-3z" />
  ...
  shield: (
    <>
      <path d="M12 3L5 6v6c0 4.5 3 8.5 7 9.5 4-.5 7-5 7-9.5V6l-7-3z" />
  ...
  'user-cog': (
    <>
      ...
      <path d="M4 19c0-3 2.5-5 6-5" />
      <circle cx="18" cy="14" r="2" />
      <path d="M18 11.5V12.5M18 15.5V16.5M15.5 14H14.5M21.5 14H20.5M16.2 12.2l-.7-.7M20.5 15.8l-.7-.7M20.5 12.2l-.7.7M16.2 15.8l-.7.7" />
    </>
  ),
  logout: (
    <>
      <path d="M10 4H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4" />
      <path d="M14 10l4 4-4 4M18 14H10" />
    </>
  ),
  ...
  'eye-off': (
    <>
      <path d="M2 12s3.5-7 10-7c2 0 3.7.7 5 1.8" />
      <path d="M22 12s-3.5 7-10 7c-1.5 0-2.9-.3-4.2-.8" />
      <path d="M3 3l18 18" />
    </>
  ),
  loader: (
    <>
      <path d="M12 3a9 9 0 1 0 9 9" opacity="0.4" />
  ...
  megaphone: (
    <>
      <path d="M4 10v4l8 4V6L4 10z" />
      <path d="M16 8v8a3 3 0 0 0 0-8z" />
  ...
  message: (
    <>
      <path d="M4 5h16v11a1 1 0 0 1-1 1H8l-4 3V5a1 1 0 0 1 1-1z" />
    </>
  ),
  pencil: (
    <>
      <path d="M4 18l1-1 10-10 3 3L8 20H4v-4z" />
      <path d="M13 7l3 3" />
    </>
  ),
  trash: (
    <>
      <path d="M5 7h14M9 7V5h6v2M8 7v12h8V7" />
  ...
  phone: (
    <path d="M6.5 4h3l1.5 4-2 1.5a11 11 0 0 0 5 5L17.5 12 21 13.5v3A2.5 2.5 0 0 1 18.5 19C10.5 19 5 13.5 5 5.5A2.5 2.5 0 0 1 6.5 4z" />
  ),
  bell: (
    <>
